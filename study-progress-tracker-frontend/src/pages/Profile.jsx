...
const Profile = () => {
  const subjects = [
    { id: 1, name: "Cyber Law" },
    { id: 2, name: "Cyber Crimes & Legal Framework" },
    { id: 3, name: "Overview of Cyber Security" },
    { id: 4, name: "Cyber Security Vulnerabilities" },
    { id: 5, name: "Securing Web Application" }
  ];
  ...
  const units = [
    {
      ...
      questions: [
        {
          id: 1,
          question: "What is the importance of cyber law in the digital age?",
          options: [
            { id: 1, text: "To regulate internet usage", isCorrect: false },
            { id: 2, text: "To prevent cyber crimes", isCorrect: false },
            { id: 3, text: "To provide legal framework for cyberspace", isCorrect: true },
    ...
    },
    {
      id: 2,
      subjectId: 2,
      name: "Unit 2: Cyber Jurisprudence",
      questions: [
        {
          id: 1,
          question: "What is cyber jurisprudence?",
          options: [
            { id: 1, text: "Study of cyber warfare tactics", isCorrect: false },
            { id: 2, text: "Legal principles and precedents related to cyber law", isCorrect: true },
            { id: 3, text: "Enforcement of cyber laws in international jurisdictions", isCorrect: false },
  ...
  const handleSubjectSelect = (subject) => {
    ...
    setSelectedUnit(null); // Reset selected unit when subject changes
  };
  ...
  return (
    <div className="container mx-auto p-10">
      ...
      <div className="flex flex-wrap mb-4">
        <select className="px-4 py-2 rounded shadow mb-4" onChange={(e) => handleSubjectSelect(JSON.parse(e.target.value))}>
      ...
      {selectedSubject && (
        <>
          <h2 className="text-2xl font-bold mb-4">Select Chapter</h2>
          <div className="flex flex-wrap mb-4">
            <select className="px-4 py-2 rounded shadow mb-4" onChange={(e) => handleUnitSelect(JSON.parse(e.target.value))}>
              <option value="">Select Chapter</option>
              {units.filter(unit => unit.subjectId === selectedSubject.id).map((unit) => (
                <option key={unit.id} value={JSON.stringify(unit)}>
                  {unit.name}
                </option>
              ))}
